...
copy_to_bigquery = GCSToBigQueryOperator(
    ...
    source_objects=['producaobh/recadetebh.csv'],  # Substitua pelo caminho do seu arquivo no GCS
    destination_project_dataset_table='etlgcp-416120.PRODUÇÃO.recadetebh',  # Substitua pelo destino no BigQuery
